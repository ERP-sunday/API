...
import { ApiSecurity, ApiTags, ApiOperation, ApiResponse, ApiBody, ApiParam } from '@nestjs/swagger';
...
export class UserController {
  ...
  @ApiResponse({ status: 200, description: 'The current user information.', type: UserDTO })
  ...
  @ApiResponse({ status: 200, description: 'The user has been successfully updated.', type: UserUpdateDTO })
  @ApiBody({ type: UserUpdateDTO })
  @ApiParam({ name: 'userId', description: 'The ID of the user to update' })
  async updateUser(@Body() body: UserUpdateDTO, @Param('userId') userId: string) {
